    ...
    <footer className="border-top" style={{ backgroundColor: "rgb(250, 250, 250)" }}>
      <div className="container mt-5">
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
          ...
          <p>
            For any complaints pertaining to securities broking please write to <a href="mailto:complaints@zerodha.com">complaints@zerodha.com</a>, for DP
            related to <a href="mailto:dp@zerodha.com">dp@zerodha.com</a>. Please ensure you carefully read the Risk
        ...
        <div className="footer-links mx-5 mt-3 mb-3">
          <a className="mx-3 text-muted" href="#" style={{textDecoration: "none"}}>NSE</a>
          <a className="mx-3 text-muted" href="#" style={{textDecoration: "none"}}>BSE</a>
          <a className="mx-3 text-muted" href="#" style={{textDecoration: "none"}}>MCX</a>
          <a className="mx-3 text-muted" href="#" style={{textDecoration: "none"}}>Terms & conditions</a>
          <a className="mx-3 text-muted" href="#" style={{textDecoration: "none"}}>Policies & procedures</a>
          <a className="mx-3 text-muted" href="#" style={{textDecoration: "none"}}>Privacy policy</a>
          <a className="mx-3 text-muted" href="#" style={{textDecoration: "none"}}>Disclosure</a>
          <a className="mx-3 text-muted" href="#" style={{textDecoration: "none"}}>For investor's attention</a>
          <a className="mx-3 text-muted" href="#" style={{textDecoration: "none"}}>Investor charter</a>
        </div>
      </div>
    </footer>
  );
