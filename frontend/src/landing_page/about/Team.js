    ...
    return (
        <div className="container">
            ...
            <div
                ...
                style={{lineHeight: "1.85", fontSize: "1.1em"}}
                >
                <div className="col-6 mt-3 mb-5 p-3 text-center">
                    <img
                ...
                <div className="col-6 mt-3 mb-5 p-3" style={{lineHeight: "1.85", fontSize: "1.1em", color:"#424242"}}>
                    <p>
